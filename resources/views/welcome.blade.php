...
})(window,document,'script','dataLayer','GTM-T5RKS3Q');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-T5RKS3Q"
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <section class="font-sans container m-auto flex px-5">
        ...
        <div class="flex-1 flex items-start flex-col justify-center">
            <h1 class="my-4 font-medium mt-40 lg:mt-32 lg:mt-0 text-center w-full px-2 text-gray-800 text-2xl xl:text-3xl lg:px-0 font-black mb-8 md:w-full lg:text-left lg:-mt-4 h-auto xl:h-24">A Course Platform <span id="title" class="text-pink-500"></span></h1>
            <p class="leading-normal mb-12 pr-36 text-normal xl:text-lg text-center w-full px-16 text-gray-600 leading-loose xl:pr-32 md:text-center md:px-32 sm:text-center lg:text-left lg:px-0">Create a kickass course and integrate your favorite services including stripe, braintree, mailchimp, and many others!</p>

            <form class="block sm:flex w-full px-0 sm:px-16 xl:pr-32 lg:pr-16 md:px-32 lg:px-0" action="https://47creations47.us2.list-manage.com/subscribe/post?u=298e1e9a200a0e311c5f71f26&amp;id=143ed34f44" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" target="_blank" novalidate="">
    ...
    <section class="bg-gray-100">
        ...
        <div class="container mx-auto mt-0 pb-4 md:pb-24 px-5">
            ...
            <h2 class="w-full pt-8 sm:pt-16 pt-4 text-2xl sm:text-4xl font-bold text-left text-indigo-500 uppercase">Our Features</h2>
            ...
            <div class="block md:flex flex-wrap mb-16 bg-white rounded shadow overflow-hidden">
                ...
                <div class="w-full md:w-1/2 py-12 md:py-0 flex flex-col justify-center px-8 sm:px-16">
                    ...
                    <p class="text-gray-600 text-xs">You can integrate your Stripe or Braintree payment system right into your course. This means when someone pays for your course, the money will be deposited directly into your account!</p>
                </div>
            ...
            <div class="block md:flex flex-wrap mb-16 bg-white rounded shadow overflow-hidden">
                ...
                <div class="w-full md:w-1/2 py-12 md:py-0 flex flex-col justify-center px-8 sm:px-16">
                    <h3 class="text-xl lg:text-3xl font-bold leading-none mb-3 mt-16 text-gray-700 -mt-1">Developer focused courses</h3>
    ...
    <section class="text-center pt-32 pb-40 bg-pink-500 relative">
        ...
        <div class="container mx-auto text-center px-5">
            <h1 class="w-full my-2 text-2xl sm:text-3xl lg:text-5xl font-bold leading-tight text-left sm:text-center text-white">Sign up to be notified when we release!</h1>
            <h3 class="my-4 mb-6 lg:mb-4 text-xl lg:text-3xl leading-tight text-gray-200 text-left sm:text-center">Enter your email below to request early access.</h3>
            <form class="block sm:flex w-full px-0 sm:px-16 xl:pr-6 lg:pr-16 md:px-32 lg:px-0 lg:w-1/2 lg:m-auto lg:mt-8" action="https://47creations47.us2.list-manage.com/subscribe/post?u=298e1e9a200a0e311c5f71f26&amp;id=143ed34f44" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" target="_blank" novalidate="">
